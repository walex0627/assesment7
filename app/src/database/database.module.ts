...
import { join } from 'path'; // ¡Necesitas esta importación!
        ...
        TypeOrmModule.forRootAsync({
            ...
            DB: ${database}`
                ...
                return {
                    ...
                    // 🔑 CORRECCIÓN CLAVE: Define explícitamente la ruta de las entidades.
                    // Esto resuelve el error de metadatos faltantes.
                    entities: [join(__dirname, '..', '**', '*.entity{.ts,.js}')], 
                    
                    autoLoadEntities: true, // Mantener, aunque ya es redundante con entities definidas
                    synchronize: true,
                    logging: ['error'],
                };
            },
